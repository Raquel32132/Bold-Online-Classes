...
import Video from '../components/ModalVideoYoutube.jsx';
              ...
              <Col lg={8}> 
                ...
                <Row className="justify-content-center mt-5 mb-3">
                  <Col className="text-center mt-5">
                    ...
                    <h2 className="intro">HTML/CSS + Criação do seu Portfolio</h2>
                  </Col>
                </Row>
              ...
              <Col lg={8}>
                ...
                <Row>
                    <Col className="next-classe text-right p-0 mb-5">
                        <Link to={'/WebDesign2'}>Continuar para a próxima aula</Link>
                    </Col>
                    <Col lg={1}>
                        <Link to={'/WebDesign2'}>
                            <Image src={Seta}/>
